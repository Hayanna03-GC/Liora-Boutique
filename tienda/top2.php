...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	      ...
	      <div>
			   	<img src="img-icon/topVN.png" class="negra"/>
			   	<img src="img-icon/topVB.png" class="blanca"/>
		   </div>
	    
	    <div>
	    	 <img class="topV" src="img-icon/topVer.png">
	    </div>
	    
	    <div class="info">
	            <h3>Top Lencero Satinado.<br></br>₡15.000</h3>

	            <p>
	          		Top de tirantes finos con escote tipo cowl, elaborado<br />
	          		en tela satinada fluida, perfecto para un look<br />
	          		nocturno elegante y minimalista.
	            </p>
	             ...
	             <h4>Tipo de tela</h4>
			       ...
			       <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Top Lencero Satinado">

					    <input type="hidden" name="precio" value="15000">

					    <input type="hidden" name="imagen" value="img-icon/topVer.png">
