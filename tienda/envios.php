...
<html>
	...
	<body>
		...
		<div class="envios">
		    ...
		    <p>
		        Realizamos envíos a todo Costa Rica para que puedas recibir tus prendas
		        favoritas desde cualquier lugar.
		    </p>

		    <h3>¿Cómo funciona el envío?</h3>

		    <p>
		        Una vez confirmada tu compra, prepararemos tu pedido y será enviado a
		        la dirección proporcionada durante el proceso de compra.
		    </p>

		    <h3>Tiempo de entrega</h3>

		    <p>
		        El tiempo de entrega dependerá de la ubicación del cliente. Recibirás
		        la información correspondiente sobre el estado de tu pedido.
		    </p>

		    <h3>Seguimiento del pedido</h3>

		    <p>
		        Podrás consultar el estado de tu envío para conocer el avance de la
