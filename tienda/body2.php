	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/bodyalN.png" class="negra"/>
			   	<img src="img-icon/bodyalC.png" class="bcafe"/>
		   </div>
		    ...
		    <div class="info">
		            <h3>Body Cuello Alto <br></br>₡11.000</h3>

		            <p>
		           		Body sin mangas de cuello alto y corte cerrado,<br /> 
		           		diseñado en un tejido elástico que se adapta<br /> 
			        ...
			        <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Body Cuello Alto">

					    <input type="hidden" name="precio" value="11000">

					    <input type="hidden" name="imagen" value="img-icon/img16.png">
