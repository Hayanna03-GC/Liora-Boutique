	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/body_negro.png" class="negra"/>
	    ...
	    <div class="info">
	            <h3>Body De Encaje<br></br>₡20.000</h3>

	            <p>
	           		Body ajustado de manga larga confeccionado íntegramente<br>
	           	    en encaje floral semitransparente, diseñado para</br> 
	           	    aportar un toque sensual y elegante.
	            </p>
	             <h4>Tipo de tela</h4>
			        <p>Encaje.</p>
			        ...
			        <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Body De Encaje">

					    <input type="hidden" name="precio" value="20000">

					    <input type="hidden" name="imagen" value="img-icon/img19.png">
					    ...
					    <div class="colores">
					        ...
					        <label class="opcion-color">
					            <input type="radio" name="color" value="negro" required>
