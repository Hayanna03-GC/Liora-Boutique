	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/tercioN.png" class="negra"/>
			   	<img src="img-icon/tercioB.png" class="blanca"/>
		   </div>
		    ...
		    <div class="info">
		            <h3>Body De Terciopelo<br></br>₡22.000</h3>

		            <p>
		           		Body de manga larga y cuello alto con una pronunciada<br /> 
		           		abertura en la espalda, confeccionado en suave<br /> 
		           		terciopelo que aporta textura y un<br /> 
		           		acabado lujoso.
		            </p>
		               <h4>Tipo de tela</h4>
				        <p>Terciopelo.</p>
				        ...
				        <form action="carrito.php" method="POST">
						    ...
						    <input type="hidden" name="producto" value="Body De Terciopelo">

						    <input type="hidden" name="precio" value="22000">

						    <input type="hidden" name="imagen" value="img-icon/img20.png">
