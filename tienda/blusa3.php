...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	    	...
	    	<div>
	    		<img src="img-icon/estampadaN.png" class="negra"/>
	    		<img src="img-icon/estampadaC.png" class="bcafe"/>
	    	</div>
	    
		    <div class="imagen-producto">
		    	  <img src="img-icon/blusa-es.png" class="blusa-es"/>
		    </div>
		    
		    <div class="info">
		        <h3>Blusa Estampada<br></br>₡10.000</h3>

		        <p>
		             Blusa fabricada en viscosa estampada de textura fluida<br>
		             con un patrón abstracto y distintivo. Incluye un detalle de</br>
		             lazo en la cintura que permite ajustar la prenda para resaltar la figura.
		        </p>
		        ...
		        <form action="carrito.php" method="POST">
				    ...
				    <input type="hidden" name="producto" value="Blusa Estampada">

				    <input type="hidden" name="precio" value="10000">

				    <input type="hidden" name="imagen" value="img-icon/blusa-es.png">
				    ...
				    <div class="tallas">
				        ...
				        <label class="opcion-talla">
				            <input type="radio" name="talla" value="S" required>
				            <span>S</span>
				        </label>
