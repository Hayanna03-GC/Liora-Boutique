...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/topN.png" class="negra"/>
			   	<img src="img-icon/topC.png" class="bcafe"/>
		   </div>
		    <div>
		    	 <img class="topM" src="img-icon/top-B.png">
		    </div>
		    
		    <div class="info">
		            <h3>Top con hombros Descubierto<br></br>₡11.000</h3>

		            <p>
		           Prenda de corte ajustado estilo off-the-shoulder<br /> 
		           confeccionada en tejido de punto elástico, que<br /> 
		           resalta los hombros y aporta un estilo<br />
		           romántico y femenino.
			        ...
			        <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Top con hombros Descubierto">

					    <input type="hidden" name="precio" value="11000">

					    <input type="hidden" name="imagen" value="img-icon/top-B.png">
