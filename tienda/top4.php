...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	      ...
	      <div>
			   	<img src="img-icon/basicaB.png" class="blanca"/>
			   	<img src="img-icon/basicaC.png" class="bcafe"/>
		 </div>
	    
	    <div>
	    	<img src="img-icon/basicaN.png" class="basico"/>
	    </div>
	    
	    <div class="info">
	            <h3>Top Básico<br></br>₡5.000</h3>

	            <p>
	          		Top de corte clásico con escote cuadrado<br />
	          		y mangas al codo, elaborado en tejido<br /> 
	          		de canalé elástico, una pieza<br />
	          		esencial y versátil
	            </p>
	             ...
	             <h4>Tipo de tela</h4>
			        ...
			        <form action="carrito.php" method="POST">
						    ...
						    <input type="hidden" name="producto" value="Top Básico">

						    <input type="hidden" name="precio" value="5000">

						    <input type="hidden" name="imagen" value="img-icon/basicaN.png">
