...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	    	...
	    	<div>
	    		<img src="img-icon/blusa-b.png" class="blanca"/>
	    		<img src="img-icon/blusa-cafe.png" class="bcafe"/>
	    	</div>
	    
		    <div class="imagen-producto">
		    	  <img class="blusaN" src="img-icon/blusa-N.png">
		    </div>
		    
		    <div class="info">
		            <h3>Blusa Escote V<br></br>₡20.000</h3>

		            <p>
		              Blusa confeccionada en poliéster vaporoso que incorpora mangas cortas<br /> 
		              con caída tipo mariposa y un escote en V profundo, ideal para un look<br />
		              veraniego o sofisticado.
		            </p>
		            
		            <h4>Tipo de tela</h4>
		            <p>Poliéster Vaporoso.</p>
		        
			  <form action="carrito.php" method="POST">

			    <input type="hidden" name="accion" value="agregar">

			    <input type="hidden" name="producto" value="Blusa Escote V">

			    <input type="hidden" name="precio" value="20000">

			    <input type="hidden" name="imagen" value="img-icon/blusa-N.png">
