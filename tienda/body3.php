	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/bodysinN.png" class="negra"/>
			   	<img src="img-icon/bodysinB.png" class="blanca"/>
		   </div>
	    <div>
	    ...
	    <div class="info">
	            <h3>Body De Tirantes Con Abertura<br></br>₡15.000</h3>

	            <p>
	           		Body de tirantes finos con aberturas laterales estratégicas<br /> 
	           		en la cintura, ofreciendo un diseño moderno y arriesgado.
	            </p>
	            <h4>Tipo de tela</h4>
			        <p>Elástica.</p>
			       ...
			       <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Body De Tirantes Con Abertura">

					    <input type="hidden" name="precio" value="15000">

					    <input type="hidden" name="imagen" value="img-icon/img18.png">
