	...
	<body class="body-comprar">
		...
		<div class="comprar">
		    ...
		    <form action="comprar.php" method="POST">
				...
				<input type="text" name="direccion" placeholder="Ingrese su dirección" required><br />

				<h3>Información de pago</h3><br />

				<label>Número de tarjeta</label><br />
				<input type="text" name="tarjeta" placeholder="0000 0000 0000 0000" required><br />
