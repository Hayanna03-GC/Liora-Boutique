...
<html>
	<head>
		<meta charset="utf-8">
		<title>Politicasd de privacidad</title>
	...
	<body>
		...
		<div class="privacidad">
		    ...
		    <p>
		        En nuestra tienda nos comprometemos a proteger la información personal
		        de nuestros clientes y utilizarla únicamente para brindar un mejor
		        servicio.
		    </p>
		    ...
		    <p>
		        ...
		        dirección y datos necesarios para procesar las compras y brindar
		        atención al cliente.
		    </p>
		    ...
		    <p>
		        La información proporcionada será utilizada para gestionar pedidos,
		        comunicarnos con los clientes y mejorar la experiencia de compra.
		    </p>

		    <h3>Protección de datos</h3>

		    <p>
		        Mantenemos medidas de seguridad para proteger la información de
		    ...
		    <p>
		        Los pagos realizados en línea mediante tarjeta son procesados de forma
		        segura para proteger los datos de nuestros clientes.
		    </p>

		    <h3>Actualización de la política</h3>

		    <p>
		        Nos reservamos el derecho de actualizar estas políticas cuando sea
		        necesario para mejorar nuestros servicios.
		    </p>
