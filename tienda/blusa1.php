...
<html>
	...
	<body>
	   ...
	   <div>
	   	<img src="img-icon/blusa-blanca.png" class="blanca"/>
	   	<img src="img-icon/blusa-negra.png" class="negra"/>
	   </div>
	    ...
	    <div class="info">
	        ...
	        <h3>Blusa de raso.<br>₡8.000</h3>

	        <p>
	            Elegante blusa confeccionada en raso de acabado sedoso y brillante.<br>
	            Destaca por su sofisticada lazada en el cuello, ideal para un estilo formal.
	        </p>
	       ...
	       <form action="carrito.php" method="POST">
			    ...
			    <input type="hidden" name="producto" value="Blusa de raso">

			    <input type="hidden" name="precio" value="8000">

			    <input type="hidden" name="imagen" value="img-icon/blusa-raso.png">
