	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	    	...
	    	<div>
			   	<img src="img-icon/bodymanB.png" class="blanca"/>
			   	<img src="img-icon/bodymanC.png" class="bcafe"/>
		   </div>
		    ...
		    <div class="info">
		            <h3>Body Manga Larga.<br></br>₡6.500</h3>

		            <p>
		           		Body ajustado de color liso con escote profundo<br />
		           	    en V y mangas largas, confeccionado en tela<br />
		           	    elástica que garantiza una silueta limpia<br />
		           	    y sin pliegues.
		            </p>
		            <h4>Tipo de tela</h4>
			        <p>Elástica.</p>
			        ...
			        <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Body Manga Larga">

					    <input type="hidden" name="precio" value="6500">

					    <input type="hidden" name="imagen" value="img-icon/bodyMan.png">
