	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
		      ...
		      <div>
				   	<img src="img-icon/topmlB.png" class="blanca"/>
				   	<img src="img-icon/topmlC.png" class="bcafe"/>
			 </div>
		    
		    <div>
		    	<img src="img-icon/topmlV.png" class="topLa"/>
		    </div>
		    
		    <div class="info">
		            <h3>Top Manga Larga<br></br>₡15.000</h3>

		            <p>
		          		Top ajustado de escote corazón y mangas largas,<br />
		          		fabricado en tela de canalé con textura<br />
		          		acanalada, ideal para un look casual<br />
		          		pero estructurado.
		            </p>
			  		 <h4>Tipo de tela</h4>
					 <p>Canalé.</p>
					...
					<form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Top Manga Larga">

					    <input type="hidden" name="precio" value="15000">

					    <input type="hidden" name="imagen" value="img-icon/topmlV.png">
