	...
	<body>
	    ...
	    <header class="segundario">
	     ...
	     <section class="producto">
	      ...
	      <div>
			   	<img src="img-icon/topcueB.png" class="blanca"/>
			   	<img src="img-icon/topcueC.png" class="bcafe"/>
		 </div>
	    
	    <div>
	    	<img src="img-icon/topcueN.png" class="topC"/>
	    </div>
	    
	    <div class="info">
	            <h3>Top Cuello Alto<br></br>₡8.000</h3>

	            <p>
	          		Top sin mangas con cuello subido, elaborado<br>
	          	    en material sintético tipo piel con</br>
	          	    acabado brillante, que ofrece un<br />
	          	    toque moderno y atrevido.
	            </p>
	             ...
	             <h4>Tipo de tela</h4>
			        ...
			        <form action="carrito.php" method="POST">
					    ...
					    <input type="hidden" name="producto" value="Top Cuello Alto">

					    <input type="hidden" name="precio" value="8000">

					    <input type="hidden" name="imagen" value="img-icon/topcueN.png">
