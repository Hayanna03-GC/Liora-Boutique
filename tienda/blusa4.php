...
<html>
	...
	<body>
	    ...
	    <section class="producto">
	       ...
	       <div>
	    		<img src="img-icon/hombreraN.png" class="negra"/>
	    		<img src="img-icon/hombreraC.png" class="bcafe"/>
	    	</div>
	    
	    <div class="imagen-producto">
	    	  	<img src="img-icon/blusaH.png" class="hombrera"/>
	    </div>
	    
	    <div class="info">
	            <h3>Blusa Manga Larga y Hombreras<br></br>₡7.000</h3>

	            <p>
	            Blusa de tejido de punto con mangas largas,<br /> 
	            corte ajustado y hombreras marcadas que<br /> 
	            crean una estructura definida y elegante.
	            </p>
		        ...
		        <form action="carrito.php" method="POST">
				    ...
				    <input type="hidden" name="producto" value="Blusa Manga Larga y Hombreras">

				    <input type="hidden" name="precio" value="7000">

				    <input type="hidden" name="imagen" value="img-icon/blusaH.png">
